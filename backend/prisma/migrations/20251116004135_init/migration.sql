...
-- CreateIndex
CREATE INDEX "DirectMessage_user1Id_idx" ON "DirectMessage"("user1Id");

-- CreateIndex
CREATE INDEX "DirectMessage_user2Id_idx" ON "DirectMessage"("user2Id");

-- CreateIndex
CREATE UNIQUE INDEX "DirectMessage_user1Id_user2Id_key" ON "DirectMessage"("user1Id", "user2Id");

-- CreateIndex
CREATE INDEX "DMMessage_convoId_idx" ON "DMMessage"("convoId");

-- CreateIndex
CREATE INDEX "DMMessage_senderId_idx" ON "DMMessage"("senderId");

-- CreateIndex
CREATE INDEX "DMMessage_receiverId_idx" ON "DMMessage"("receiverId");
